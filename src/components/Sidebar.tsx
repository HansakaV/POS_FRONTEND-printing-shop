...
import { LogOut, BookOpen, Users, Home, Bell, ArrowRightLeft, User, TrendingUp, Package, DollarSign } from 'lucide-react';
...
const Sidebar: React.FC = () => {
  ...
  const quickStats = [
    ...
    { label: 'Orders', value: stats.totalOrders, icon: TrendingUp, color: 'text-orange-400' },
    { label: 'Items', value: stats.activeItems, icon: Package, color: 'text-green-400' },
    { label: 'Revenue', value: `$${(stats.revenue / 1000).toFixed(1)}k`, icon: DollarSign, color: 'text-blue-400' },
  ];
              ...
              {quickStats.map((stat, index) => {
                ...
                return (
                  <div
                    ...
                    className="bg-white/5 backdrop-blur-sm rounded-lg p-3 border border-white/10 hover:bg-white/10 transition-all duration-300 animate-scaleIn cursor-pointer"
                  >
